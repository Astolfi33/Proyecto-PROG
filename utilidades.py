...
def es_palindromo(texto: str) -> bool:
  ...
  texto = texto.replace("", "").lower() # Reemplazamos los espacios del string por nada, para que el programa se centre en los caracteres
...
if __name__ == '__main__':
  sumar_numeros(2, 4)
  euros_a_bitcoins(44471.78)
  bitcoins_a_euros(1)
  contar_vocales("peloteo")
  es_palindromo("Ana")
  max_temperaturas([30, 95.6, 82, 20, 4], 40)
  insertar("Lechuga")
  insertar("Galletas")
  insertar("Arroz")
  borrar(0)
  mostrar_productos()
  cantidad()
  msg_cifrado = cifrar('hola mundo', 20)
  descifrar(msg_cifrado, 20) 
'''
